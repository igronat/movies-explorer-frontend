...
function Navigation({
    ...
    return (
        ...
        <NavLink exact to="/" className={`navigation__link navigation__link_type_hamburger navigation__link_type_${hidden}`} activeClassName="navigation__link_active">Главная</NavLink>
