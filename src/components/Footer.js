...
function Footer() {
    ...
    return (
        ...
        <nav className="footer__list">
            ...
            <a className="footer__link" href="https://github.com/igronat" target="_blank">Github</a>
            <a className="footer__link" href="https://vk.com/nata.radina" target="_blank">ВКонтакте</a>
        </nav>
        </div>
